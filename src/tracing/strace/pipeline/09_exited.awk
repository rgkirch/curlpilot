...
{
    # We only want to process lines that the first script tagged as "exited".
    if ($1 == "exited") {
        # --- This is the logic for processing exited lines ---
        ...
        # 1. Convert timestamp to microseconds. This is another definitive "end time".
