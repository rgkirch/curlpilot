...
# Source the project's dependency script.
...
(
  # Redirect this subshell's stderr to a log file to preserve debug traces.
  exec 2> /tmp/copilot_server.log
  ...
  # Close the inherited stdout pipe just before starting the blocking server command.
  exec 1>&-
