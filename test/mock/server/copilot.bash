...
# Source the project's dependency script to make helpers and the dependency
...
# Detach the background server process from the current shell.
# This allows this script to exit immediately without waiting for nc.
disown "$SERVER_PID"
